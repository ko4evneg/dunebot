...
ботом: `/register Имя (ник_steam) Фамилия`. Нужно вводить именно в таком в формате: Имя и Фамилия - это ваши реальные
...
_<pre>В реализации: замена этой команды командой /register</pre>_
