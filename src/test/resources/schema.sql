...
CREATE TABLE RATING_MATCH_STATS
(
    ID                            BIGSERIAL PRIMARY KEY,
    TOTAL_PLAYERS_MATCHES_COUNT   INT                      NOT NULL,
    FAILED_PLAYERS_MATCHES_COUNT  INT                      NOT NULL,
    SUCCEED_PLAYERS_MATCHES_COUNT INT                      NOT NULL,
    TOTAL_LEADERS_MATCHES_COUNT   INT                      NOT NULL,
    FAILED_LEADERS_MATCHES_COUNT  INT                      NOT NULL,
    SUCCEED_LEADERS_MATCHES_COUNT INT                      NOT NULL,
    CREATED_AT                    TIMESTAMP WITH TIME ZONE NOT NULL,
    UPDATED_AT                    TIMESTAMP WITH TIME ZONE
);

CREATE TABLE RATING_PLAYER_STATS
(
    ID            BIGSERIAL PRIMARY KEY,
    PLAYER_ID     BIGINT REFERENCES PLAYERS (ID),
    ...
    CREATED_AT    TIMESTAMP WITH TIME ZONE NOT NULL,
    UPDATED_AT TIMESTAMP WITH TIME ZONE,
    CONSTRAINT UNQ_DATE_PLAYER UNIQUE (PLAYER_ID, START_DATE)
);

CREATE TABLE RATING_LEADER_STATS
(
    ID            BIGSERIAL PRIMARY KEY,
    LEADER_ID     BIGINT REFERENCES LEADERS (ID),
    MATCHES_COUNT INT                      NOT NULL,
    EFFICIENCY    DOUBLE PRECISION         NOT NULL,
    WIN_RATE      DOUBLE PRECISION         NOT NULL,
    START_DATE    DATE                     NOT NULL,
    ...
    CREATED_AT    TIMESTAMP WITH TIME ZONE NOT NULL,
    UPDATED_AT TIMESTAMP WITH TIME ZONE,
    CONSTRAINT UNQ_DATE_LEADER UNIQUE (LEADER_ID, START_DATE)
)
