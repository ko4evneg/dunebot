...
class TelegramUpdateProcessorTest extends TestContextMock {
    ...
    void beforeEach() {
        ...
        doReturn("100").when(settingsService).getStringSetting(AppSettingKey.CHAT_ID);
        doReturn(124).when(settingsService).getIntSetting(AppSettingKey.TOPIC_ID_CLASSIC);
        doReturn(125).when(settingsService).getIntSetting(AppSettingKey.TOPIC_ID_UPRISING);
