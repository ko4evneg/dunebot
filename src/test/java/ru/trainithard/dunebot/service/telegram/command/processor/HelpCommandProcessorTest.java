    ...
    private String getExpectedHelpText() {
        return """
                *Dunebot v1\\.3*
                ...
                '/new\\_dune' Создание опроса для классической Dune
                '/new\\_up4' Создание опроса для Dune Uprising \\(4 игрока\\)
                '/new\\_up6' Создание опроса для Dune Uprising \\(6 игроков\\)\\. Только для сбора матча по опросу\\. Результаты не собираются\\.
