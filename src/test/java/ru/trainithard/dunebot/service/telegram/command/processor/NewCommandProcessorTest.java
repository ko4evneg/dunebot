...
class NewCommandProcessorTest extends TestContextMock {
    ...
    void beforeEach() {
        ...
        jdbcTemplate.execute("insert into settings (id, key, value, created_at) " +
                             "values (10000, '" + SettingKey.CHAT_ID + "', '" + TestConstants.CHAT_ID + "', '2010-10-10')");
        jdbcTemplate.execute("insert into settings (id, key, value, created_at) " +
                             "values (10001, '" + SettingKey.TOPIC_ID_CLASSIC + "', 2, '2010-10-10')");
        jdbcTemplate.execute("insert into settings (id, key, value, created_at) " +
                             "values (10002, '" + SettingKey.TOPIC_ID_UPRISING + "', 4, '2010-10-10')");
