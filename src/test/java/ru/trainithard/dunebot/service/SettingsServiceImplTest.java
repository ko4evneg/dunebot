...
class SettingsServiceImplTest extends TestContextMock {
    ...
    void shouldReturnStringSetting() {
        String actualValue = settingsService.getStringSetting(AppSettingKey.CHAT_ID);
    ...
    void shouldReturnLongSetting() {
        long actualValue = settingsService.getLongSetting(AppSettingKey.ADMIN_USER_ID);
    ...
    void shouldReturnIntSetting() {
        int actualValue = settingsService.getIntSetting(AppSettingKey.TOPIC_ID_CLASSIC);
    ...
    void shouldSaveSetting() {
        ...
        settingsService.saveSetting(AppSettingKey.CHAT_ID, "val");
    ...
    void shouldUpdateSetting() {
        settingsService.saveSetting(AppSettingKey.TOPIC_ID_CLASSIC, "100");
    ...
    void shouldReturnCachedValue() {
        String firstRequest = settingsService.getStringSetting(AppSettingKey.CHAT_ID);
        jdbcTemplate.execute("update app_settings set value = 'newVal' where id = 10000");
        String secondRequest = settingsService.getStringSetting(AppSettingKey.CHAT_ID);
    ...
    void shouldUpdateCachedValue() {
        String firstRequest = settingsService.getStringSetting(AppSettingKey.CHAT_ID);
        settingsService.saveSetting(AppSettingKey.CHAT_ID, "newVal");
        String secondRequest = settingsService.getStringSetting(AppSettingKey.CHAT_ID);
